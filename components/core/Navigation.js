        ...
        <div className="container mx-auto p-4 flex flex-wrap items-center md:flex-no-wrap">
          ...
          <div className="w-full md:w-auto md:flex-grow md:flex md:items-center">
            <ul className="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:mt-0 md:pt-0 md:mr-4 md:ml-auto lg:mr-8 md:border-0">
              ...
              <li>
                <Link href="/catalog">
                  <a className="block px-4 py-1 md:p-2 lg:px-8">Catalog</a>
                </Link>
              </li>
              <li>
                <Link href="/catalog/sportswear" prefetch={false}>
                  <a className="block px-4 py-1 md:p-2 lg:px-8">Sportswear</a>
                </Link>
              </li>
              <li>
                <Link href="/catalog/elegant" prefetch={false}>
                  <a className="block px-4 py-1 md:p-2 lg:px-8">
                    Elegant Clothing
                  </a>
                </Link>
